...
export default function IdleView({ onStart }) {
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }} 
      exit={{ opacity: 0 }} 
      className="flex h-full flex-1 flex-col justify-between p-8 text-center"
    >
      <div className="mt-8">
        <h1 className="mb-2 bg-linear-to-r from-orange-500 to-yellow-400 bg-clip-text text-4xl font-black tracking-tight text-transparent drop-shadow-sm md:text-5xl">
          OLÁ, PLAYER!
        </h1>
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="mb-6 animate-pulse text-sm font-bold italic tracking-widest text-gray-500 uppercase md:text-base">
          ...aguardando o próximo movimento...
        </p>
        <svg className="h-auto w-56 drop-shadow-[0_0_20px_rgba(255,77,0,0.4)]" viewBox="0 0 600 485" xmlns="http://www.w3.org/2000/svg">
          <defs>
      ...
      <div className="group mb-8 cursor-pointer" onClick={onStart}>
        <p className="animate-pulse text-sm font-bold uppercase tracking-[0.2em] text-orange-500/90 transition-colors group-hover:text-orange-400 md:text-base">
